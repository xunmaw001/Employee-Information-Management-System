...
<!--/Pre Loader -->
                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        是否确认
                                        <div class="layui-input-inline">
                                            <select name="xinziYesnoTypesSelectSearch"  style="width: 150px;" id="xinziYesnoTypesSelectSearch" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            if( monthSearchInput != null){
                ...
                //是否确认
            var xinziYesnoTypesSelectSearchInput = document.getElementById("xinziYesnoTypesSelectSearch");
            if(xinziYesnoTypesSelectSearchInput != null){
                var xinziYesnoTypesIndex = xinziYesnoTypesSelectSearchInput.selectedIndex;
                if( xinziYesnoTypesIndex  != 0){
                    searchForm.xinziYesnoTypes= document.getElementById("xinziYesnoTypesSelectSearch").options[xinziYesnoTypesIndex].value;
                }
            }
                    getDataList();
        }
        ...
        function getDataList() {
            http("xinzi/page", "GET", {
                ...
                xinziYesnoTypes: searchForm.xinziYesnoTypes,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //是否确认
            var xinziYesnoTypesCell = document.createElement('td');
            xinziYesnoTypesCell.innerHTML = item.xinziYesnoValue;
            row.appendChild(xinziYesnoTypesCell);
    ...
    //填充本表搜索下拉框
        ...
        function xinziYesnoTypesSelectSearch() {
            var xinziYesnoTypesSelectSearch = document.getElementById('xinziYesnoTypesSelectSearch');
            if(xinziYesnoTypesSelectSearch != null) {
                xinziYesnoTypesSelectSearch.add(new Option('-请选择-',''));
                if (xinziYesnoTypesOptions != null && xinziYesnoTypesOptions.length > 0){
                    for (var i = 0; i < xinziYesnoTypesOptions.length; i++) {
                            xinziYesnoTypesSelectSearch.add(new Option(xinziYesnoTypesOptions[i].indexName,xinziYesnoTypesOptions[i].codeIndex));
                    }
                }
            }
        }
    ...
    //查询当前表搜索条件所有列表
            function xinziYesnoTypesSelect() {
                //填充下拉框选项
                http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=xinzi_yesno_types", "GET", {}, (res) => {
                    if(res.code == 0){
                        xinziYesnoTypesOptions = res.data.list;
                    }
                });
            }
