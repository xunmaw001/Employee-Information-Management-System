                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="jibenMoney" name="jibenMoney" class="form-control"
                                               onchange="jibenMoneyChickValue(this)" placeholder="工资">
                                    </div>
                                    <div class="form-group  col-md-6">
                                        <label>备注</label>
                                    ...
                                    <div class="form-group col-md-6 aaaa">
                                        <label>是否确认</label>
                                        <select id="xinziYesnoTypesSelect" name="xinziYesnoTypes" class="form-control">
                                        </select>
                                    </div>
...
<script>
    ...
    // 初始化下拉框
    <!-- 初始化当前表的下拉框 -->
        function initializationXinziyesnotypesSelect(){
            var xinziYesnoTypesSelect = document.getElementById('xinziYesnoTypesSelect');
            if(xinziYesnoTypesSelect != null && xinziYesnoTypesOptions != null  && xinziYesnoTypesOptions.length > 0 ){
                for (var i = 0; i < xinziYesnoTypesOptions.length; i++) {
                    xinziYesnoTypesSelect.add(new Option(xinziYesnoTypesOptions[i].indexName,xinziYesnoTypesOptions[i].codeIndex));
                }
            }
        }
    ...
    function setSelectOption() {
        ...
        if(xinziYesnoTypesSelect != null && xinziYesnoTypesOptions != null  && xinziYesnoTypesOptions.length > 0 ) {
            for (var i = 0; i < xinziYesnoTypesOptions.length; i++) {
                if (xinziYesnoTypesOptions[i].codeIndex == ruleForm.xinziYesnoTypes) {//下拉框value对比,如果一致就赋值汉字
                        xinziYesnoTypesSelect.options[i].selected = true;
                }
            }
        }
        <!--  级联表的下拉框回显  -->
    ...
    function getContent() {
        ...
        if($("#xinziContentupload").length>0) {
            ...
            if (xinziContentEditor.hasContents()) {
                $('#xinziContent-input').attr('value', xinziContentEditor.getPlainTxt());
            }
        }
    }
    //数字检查
        <!-- 当前表的数字检查 -->
        function jibenMoneyChickValue(e){
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#month").val(ruleForm.month);
        $("#jibenMoney").val(ruleForm.jibenMoney);
    ...
    $(document).ready(function () {
        ...
        // 初始化下拉框
            <!--  初始化当前表的下拉框  -->
            initializationXinziyesnotypesSelect();
            <!--  初始化级联表的下拉框  -->
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $('#jibenMoney').attr('readonly', 'readonly');
            var xinziContentUeditor = UE.getEditor('xinziContentEditor');
            xinziContentUeditor.ready(function () {
